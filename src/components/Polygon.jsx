  ...
  return (
    <div className="track__form">
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="blue__cloud"
        style={{ "--from": "-50%", "--to": "0", "--animationDelay": "2s" }}
      >
        <path
          d="M77 32.64C77 42.7772 68.7456 51 58.57 51H13.9255C6.23315 51 0 44.7858 0 37.1241C0 29.4702 6.23315 23.256 13.9255 23.256C14.4875 23.256 15.0342 23.3031 15.5771 23.3619C15.4315 22.3803 15.3581 21.3889 15.3576 20.3961C15.3576 9.13292 24.5245 0 35.8396 0C45.1066 0 52.9298 6.12785 55.4592 14.5428C56.4889 14.3707 57.5305 14.2841 58.5739 14.2839C68.7456 14.2839 77 22.4949 77 32.64Z"
          fill="#BBEBF0"
        />
      </svg>
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="white__cloud"
        style={{ "--from": "90%", "--to": "0", "--animationDelay": "2s" }}
      >
        <path
          d="M0 40.96C0 53.6812 10.3984 64 23.2169 64H79.4576C89.1478 64 97 56.2019 97 46.5871C97 36.9822 89.1478 29.184 79.4576 29.184C78.7495 29.184 78.0608 29.2431 77.3769 29.3169C77.5603 28.085 77.6527 26.841 77.6534 25.5951C77.6534 11.4609 66.1055 0 51.8514 0C40.1774 0 30.3222 7.68985 27.1357 18.2498C25.8387 18.0338 24.5265 17.9251 23.2121 17.9249C10.3984 17.9249 0 28.2289 0 40.96Z"
          fill="white"
        />
      </svg>

      <svg
        className="track1 track--with-line"
        width="805"
        height="97"
        viewBox="0 0 805 97"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        style={{ "--from": "70%", "--to": "0", "--animationDelay": "2s" }}
      >
        <path
          d="M2 95L805 94.9999"
          stroke="#667085"
